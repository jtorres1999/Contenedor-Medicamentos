...
Jarabes jb=new Jarabes();
Pastillas p= new Pastillas();
...
public static  DefaultTableModel d=new DefaultTableModel();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
      ...
      //LE ASIGNAMOS UNA VARIABLE INTEGER A LA FILA SELECCIONADA EN LA TABLA
            ...
            Vector[3] = tabla.getValueAt(filaSeleccionada, 3).toString();
                 if (Vector[1].equals("Jarabe")) {
                    if (Vector[3].equals("Activo")) {
                         ...
                         d.removeRow(filaSeleccionada); 
                         jb.setVisible(true);
                     }else{JOptionPane.showMessageDialog(null,"Este medicamento no está Activo");}

                 }else if (Vector[1].equals("Pastilla")) {
                     
                    if (Vector[3].equals("Activo")) {
                         Pastillas.d1.addRow(Vector);
                         d.removeRow(filaSeleccionada); 
                         p.setVisible(true);
                     }else{JOptionPane.showMessageDialog(null,"Este medicamento no está Activo");}
                 }
